...
define('pages/home/components/index',["require", "exports", "aurelia-fetch-client", "aurelia-framework"], function (require, exports, aurelia_fetch_client_1, aurelia_framework_1) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
    var HomeLanding = (function () {
        function HomeLanding(httpClient) {
        ...
        HomeLanding.prototype.constructTable = function () {
            var _this = this;
            ...
            var data = {};
            this.model.forEach(function (sale_statement) {
                sale_statement.dataset.forEach(function (data_entry) {
                    data[data_entry.brand] = data[data_entry.brand] || [];
                    if (_this.pageState.data_type === 'revenue') {
                        data[data_entry.brand].push(((_this.pageState.data_format === 'whole') ? data_entry.revenue : (data_entry.revenue / sale_statement.revenue_total * 100)).toFixed(2));
                    }
                    else {
                        data[data_entry.brand].push(((_this.pageState.data_format === 'whole') ? data_entry.units : (data_entry.units / sale_statement.unit_total * 100)).toFixed(2) + '%');
                    }
                });
            });
            for (var key in data) {
        ...
        HomeLanding.prototype.fetchModelData = function (class_obj) {
            return this.httpClient.fetch(this.pageState.model + '/' + this.pageState.time_frame)
                ...
                .then(function (data) { return class_obj.model = data; });
        };
        HomeLanding.prototype.attached = function () {
            var _this = this;
            this.fetchModelData(this)
                .then(function () {
                _this.constructTable();
            });
        };
        __decorate([
