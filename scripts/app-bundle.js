...
define('pages/home/components/index',["require", "exports", "aurelia-fetch-client", "aurelia-framework", "aurelia-binding"], function (require, exports, aurelia_fetch_client_1, aurelia_framework_1, aurelia_binding_1) {
    ...
    var HomeLanding = (function () {
        ...
        HomeLanding.prototype.createPivotData = function () {
            ...
            var field_definitions = [{ name: 'Brand', type: 'string', filterable: true },
            ...
            var jsonArray = tempArray.map(function (obj) {
                var result = {};
            ...
            var dataArray = tempArray.map(function (obj) {
                var result = [];
        ...
        HomeLanding.prototype.updateDataTable = function (dataArray, jsonArray, fields, rowLabels, columnLabels, summaries) {
...
define('resources/elements/market-view/data-table-element',["require", "exports", "aurelia-framework", "aurelia-framework", "aurelia-binding", "jquery", "datatables.net-responsive-bs", "./../../../scripts/vendors/pivot/pivot.min.js", "./../../../scripts/vendors/pivot/jquery_pivot.js"], function (require, exports, aurelia_framework_1, aurelia_framework_2, aurelia_binding_1, $, DataTable) {
    "use strict";
    Object.defineProperty(exports, "__esModule", { value: true });
